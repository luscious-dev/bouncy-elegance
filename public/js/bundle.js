...
if (createPostForm) {
  var _editor = (0, _editor3.getQuillInstance)("editor");
  createPostBtn.addEventListener("click", function (e) {
    e.preventDefault();
    var content = (0, _editor3.getHTMLContent)(_editor);
    console.log(content);
...
if (editPostForm) {
  var _editor2 = (0, _editor3.getQuillInstance)("editor");
  editPostBtn.addEventListener("click", function (e) {
    e.preventDefault();
    var content = (0, _editor3.getHTMLContent)(_editor2);
    console.log(content);
    // renderHTMLContent("output", content);
  });
}
